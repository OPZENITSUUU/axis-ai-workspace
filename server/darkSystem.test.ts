...
describe("AXIS premium dark visual system", () => {
  it("uses a switchable dark-first theme and includes reduced-motion safeguards", async () => {
    ...
    expect(home).toContain("katex/dist/katex.min.css");
    expect(home).toContain("mermaidConfig");
    expect(home).toContain('securityLevel: "strict"');
    expect(home).toContain("downloadCodeFile");
    expect(home).toContain("getCodeExportExtensions");
    expect(home).toContain("Download format");
    expect(home).toContain("safeCodeExtensions");
    expect(home).toContain("Prompt library");
    expect(home).toContain("Memory bank");
    expect(home).toContain("memoryInstructions");
    expect(home).toContain("generationDurationMs");
    expect(home).toContain("generatedWordCount");
    expect(home).toContain("/url https://example.com");
    expect(home).toContain("toggleFocusAudio");
    expect(home).toContain("does not upload or track listening");
